...
path <- here("data/Fuels_byplot_Plots_ffs_filtered_postburns.csv")
...
ggplot(data = FFS_data, aes(x = FFS_data$Timestep, y = FFS_data$fuelload_total_tonha)) +
...
ggplot(data = FFS_data_complete, aes(x = FFS_data_complete$Timestep, y = FFS_data_complete$fuelchange_total)) +
  geom_boxplot(aes(color = Treatment))

ggplot(data = FFS_data_complete, aes(x = FFS_data_complete$Timestep, y = FFS_data_complete$fuelchange_litterduff)) +
  geom_boxplot(aes(color = Treatment))

ggplot(data = FFS_data_complete, aes(x = FFS_data_complete$Timestep, y = FFS_data_complete$fuelchange_1.100h)) +
  geom_boxplot(aes(color = Treatment))
...
Examine difference between plots within compartments:
...
Base difference according to species composition:
